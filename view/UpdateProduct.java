...
public class UpdateProduct extends javax.swing.JDialog {
    ...
    public UpdateProduct(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        if (this.owner.checklap()) {
            Keyboard a = this.owner.getDetailKeyboard();
            ...
            Mouse a = this.owner.getDetailMouse();
            txtMaSanPham.setText(a.getmaSP());
            txtTenSanPham.setText(a.gettenSP());
    ...
    private void cbxloaispItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbxloaispItemStateChanged
        ...
        if (cbxloaisp.getSelectedItem().equals("Mouse - Lắp ráp")) {
            CardLayout productCategory = (CardLayout) jPanel3.getLayout();
    ...
    private void btnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddProductActionPerformed
        ...
        if (cbxloaisp.getSelectedItem().equals("Keyboard")) {
            ...
            if (maSP.equals("") || tenSP.equals("") || xuatxu.equals("")) {
                ...
                Keyboard kb = new Keyboard(maSP, tenSP, soluong, dongia, xuatxu,1);
                try {
                    KeyboardDAO.getInstance().update(kb);
                    this.dispose();
        ...
        if (cbxloaisp.getSelectedItem().equals("Mouse - Lắp ráp")) {
            ...
            if (maSP.equals("") || tenSP.equals("") ||xuatxu.equals("")) {
                ...
                Mouse Mouse = new Mouse(maSP, tenSP, soluong, dongia,xuatxu,1);
                System.out.println(Mouse);
                MouseDAO.getInstance().update(Mouse);
                this.dispose();
                JOptionPane.showMessageDialog(this, "Sửa sản phẩm thành công !");
                owner.loadDataToTable();
            }
