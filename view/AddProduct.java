...
public class AddProduct extends javax.swing.JDialog {
    ...
    public AddProduct(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        txtMaSanPham.setText(createIdKeyboard());
    }
    ...
    private void initComponents() {
        ...
        cbxloaisp.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Keyboard", "Mouse" }));
    ...
    private void cbxloaispItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbxloaispItemStateChanged
        ...
        if (cbxloaisp.getSelectedItem().equals("Keyboard")) {
            CardLayout productCategory = (CardLayout) jPanel3.getLayout();
            productCategory.first(jPanel3);
            txtMaSanPham.setText(createIdKeyboard());
        }

        if (cbxloaisp.getSelectedItem().equals("Mouse")) {
            CardLayout productCategory = (CardLayout) jPanel3.getLayout();
            productCategory.last(jPanel3);
            txtMaSanPham.setText(createIdMouse());
        }
    ...
    private void btnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddProductActionPerformed
        ...
        if (cbxloaisp.getSelectedItem().equals("Keyboard")) {
            ...
            if (maSP.equals("") && tenSP.equals("")) {
                ...
                Keyboard kb = new Keyboard(maSP, tenSP, 0, dongia, xuatxu,trangThai);
                try {
                    KeyboardDAO.getInstance().insert(kb);
                    this.dispose();
        ...
        if (cbxloaisp.getSelectedItem().equals("Mouse")) {
            ...
            if (maSP.equals("") && tenSP.equals("") ) {
                ...
                Mouse Mouse = new Mouse(maSP, tenSP, 0, dongia, xuatxu,trangThai);
                MouseDAO.getInstance().insert(Mouse);
                this.dispose();
                JOptionPane.showMessageDialog(this, "Thêm sản phẩm thành công !");
                owner.loadDataToTable();
            }
     ...
     */
    public String createIdMouse() {
        ArrayList<SP> spAll = SPDAO.getInstance().selectAll();
        ArrayList<SP> MouseAll = new ArrayList<SP>();
        for (SP SP : spAll) {
            if (SP.getmaSP().contains("Mouse")) {
                MouseAll.add(SP);
            }
        }
        int i = MouseAll.size();
    ...
    public String createIdKeyboard() {
        ArrayList<SP> spAll = SPDAO.getInstance().selectAll();
        ArrayList<SP> kbAll = new ArrayList<SP>();
        for (SP SP : spAll) {
            if (SP.getmaSP().contains("kb")) {
                kbAll.add(SP);
            }
        }
        int i = kbAll.size();
